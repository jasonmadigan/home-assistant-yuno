...
The regression test compares our bytes with Home Assistant's actual serializer. This fork sends those pre-signed
...
interfaces with fake network responses. They do not log into Yuno. The new Home
Assistant flow has not been installed on a physical Home Assistant instance as
part of this change; the live protocol check was performed with the standalone
account client before this integration was implemented.
